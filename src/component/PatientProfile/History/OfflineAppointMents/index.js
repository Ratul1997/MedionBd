...
function OfflineAppointMents(props) {
  /*
  ...
  return (
    <>
      {isLoading ? (
        ...
        <VirtualizedView>
          <UppCommingVOAppointMents appointmentSchedule={appointments} cross />
...
export default connect(mapState, actionCreators)(OfflineAppointMents);
